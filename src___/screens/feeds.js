...
class feeds extends Component {
  ...
  preExecution = () => {
    ...
    } else if (this.props.seasonStatus === "STARTED")
  ...
  popularGames = (x, y) => {
    let dd = this.props.weekBets
      ...
      .filter((a) => {
        let h1 = moment(
          new Date("2019-01-01T" + a.game.DateTime.split("T")[1])
        );
    ...
    if (return_ === "week" && this.props.playersByWeek && this.props.players && this.props.players.length > 0) {
      ...
      if (_playersByGroup) {
        ...
        if (topGroup) {
          ...
          // Total games wins
          let _topGroupGamesWin = _.flattenDeep(_topGroupGames).filter((a) => a.win)
            .length;
          // Total points win
          let _topGroupTotaltWin = topGroup.groupTotal;

          // Percentage games win
          let _topGroupPercentWin =
            _topGroupGamesWin / _.flattenDeep(_topGroupGames).length;
      ...
      <View style={{ flex: 1, }}>
        ...
        <ScrollView
          ...
          {this.props.seasonStatus === "STARTED" &&
            <View>
              {parseInt(
                (new Date(`${this.props.weekstartdate[this.props.currentWeek - 1]}.000Z`).getTime() -
                  new Date().getTime()) /
                (24 * 3600 * 1000)
              ) > 0 ?
                <View
            ...
            <View
              ...
              <View style={{ flexDirection: "row", alignSelf: "center" }}>
                ...
                <Text
                  ...
                  {this.state.range.index === 1 ? "ST" : this.state.range.index === 2 ? "ND" : this.state.range.index === 3 ? "RD" : "TH"}
                </Text>
              </View>
            </View>
            <View
          ...
          {popular && popular.night && popular.night.game ? (
            <View
              ...
              <Text
                ...
                MOST POPULAR PICK:
                {popularPick.night && popularPick.night.method
                  ? popularPick.night.method.value.toUpperCase()
                  : ""}
              </Text>
            </View>
          ) : null}
          ...
          {/* ////////////////////////////////////////////////////////////////////////////// */}
          {this.props.user && (!this.props.user.conference || this.props.user.conference.name !== "West" && this.props.user.conference.name !== "North" && this.props.user.conference.name !== "South" && this.props.user.conference.name !== "East") ? (
            <View
              style={{
                backgroundColor: "#191919",
                paddingVertical: 47,
            ...
            <View
              ...
              <Text
                ...
                {`YOU ARE NOW PART OF “${this.props.user &&
            ...
            <View>
              ...
              <View
                ...
                <Text
                  ...
                  {this.props.seasonStatus === "STARTED" ? "PLAYER OF THE WEEK" : this.props.seasonStatus === "FINISHED" ? "PLAYER OF THE SEASON" : ""}
                </Text>
                ...
                <Text
                  ...
                  {this.state.topPlayer && this.state.topPlayer.user
                    ? this.state.topPlayer.user.username
                    : ""}
                </Text>
                {this.props.seasonStatus === "FINISHED" && <Image
                  source={{
                    uri:
                      "https://icons.iconarchive.com/icons/thesquid.ink/free-flat-sample/1024/cup-icon.png",
                  }
                  }
                  style={{
                    width: 64,
          ...
          {this.props.seasonStatus !== "PREPARING" &&
            <View
              ...
              {this.props.seasonStatus === "STARTED" && <Text
                style={{
                  color: "#edd798",
                  fontFamily: "Monda",
                  fontSize: 14,
              ...
              {this.props.seasonStatus === "FINISHED" && <Text
                style={{
                  color: "#edd798",
                  fontFamily: "Monda",
                  fontSize: 14,
            ...
            <View>
                ...
                return (
                  <View
                    ...
                    <Text
                      ...
                      {this.groupByIdFunc(grp.group) && this.groupByIdFunc(grp.group).name ? this.groupByIdFunc(grp.group).name : ""}
                    </Text>
                    {_.orderBy(grp.player, ["total"], ["desc"]).map(
                      (item, index) => {
                        if (index < 3)
                          return (
                            <TouchableOpacity
                              ...
                              style={{
                                ...
                                borderBottomWidth:
                                  grp.player.length > 2 && index < 2 ? 1 : 0,
                                height: 70,
                              }}>
                              <Text
                                style={{
              ...
              {this.props.seasonStatus === "FINISHED" &&
                <View>
                  ...
                  {_.orderBy(this.props.players, ["total"], ["desc"]).map(
                    (item, index) => {
                      if (index < 10)
                        return (
                          <TouchableOpacity
          ...
          {/* <View
              ...
              <Text
                ...
                {
                  "WIt’s that time of the year. Now is the time to select 5 of the10 conference championship games and assign them a point value."
                }
              </Text>
...
const mapStateToProps = (state) => {
  ...
  const { statusGame, weekBets, players, playersByWeek, currentYear, currentWeek, seasonStatus, weekstartdate } = state.game;
  return {
    user,
    token,
    conferences,
