...
class profileTab extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevState.allPlayers !== this.state.allPlayers && this.state.allPlayers.length > 0) {
      const newPlayersList = this.state.allPlayers.filter(f => f.user._id === this.props.user._id)
      ...
      if (newPlayersList.length > 0) {
        ...
        let userRanker = _.findIndex(rankingList, o => o.user._id === this.props.user._id)

        let statsPlayerGames = rankingList.filter(i => i.user._id == this.props.user._id)[0]
  ...
  chipsWon = () => {
    ...
    let rrrr = this.state.players.filter(f => f.user.group === this.props.user.group._id)
        ...
        <View
          ...
          <View style={{ flex: 2, marginLeft: 5 }}>
            ...
            <Text
              ...
              {this.props.user && this.props.user.city ? this.props.user.city : ''},{' '}
              {this.props.user && this.props.user.state ? this.props.user.state : ''}
            </Text>
            <View
              style={{
                width: '90%',
          ...
          <View style={{ flex: 2, marginRight: 5, marginLeft: 10 }}>
            ...
            <Text
              ...
              Power |
              {this.props.user && this.props.user.conferenceCFB ? this.props.user.conferenceCFB.substring(0, 10) : ''}
            </Text>
          </View>
        </View>
        <View
