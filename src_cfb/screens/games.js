...
class Spreads extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      week:
        'Week ' +
        (this.props.seasonStatus &&
        (this.props.seasonStatus === 'STARTED' || this.props.seasonStatus === 'CHAMPIONSHIP')
                              ...
                              <TouchableOpacity
                                ...
                                onPress={() => {
                                  if (this.props.user && this.props.user.conferenceCFB) {
                                    if (
                                      this.state.favorites.filter(a => a.GlobalGameID === item2.GlobalGameID).length ==
                                      0
                                    ) {
