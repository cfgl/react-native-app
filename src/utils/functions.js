...
const gameString = game => {
  let favorite = game && game.PointSpread < 0 ? '@' + game.HomeTeam : game.AwayTeam
...
export { init, UploadImage, points, parleyPoints, perfectoPoints, GroupByGroup, betsGroupByWeek, gameString }
